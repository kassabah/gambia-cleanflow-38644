...
const TrackTrucks = () => {
  ...
  return (
    <div className="space-y-4">
      <Card className="p-6">
        <h2 className="text-2xl font-bold mb-4">Track Nearby Trucks</h2>
        <p className="text-sm text-muted-foreground mb-4">
          Real-time location of active collection trucks
        </p>
        
        {collectors.length === 0 ? (
          <p className="text-center text-muted-foreground py-8">No active trucks at the moment</p>
        ) : (
      ...
      <Card className="p-4 bg-muted/50">
        <p className="text-sm text-muted-foreground text-center">
          🗺️ Map view with Google Maps integration coming soon!
        </p>
      </Card>
    </div>
  );
